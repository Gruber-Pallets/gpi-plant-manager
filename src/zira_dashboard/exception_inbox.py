...
_ATTENDANCE_SECTION_META = {
    "attendance_cutover_blocked": ("Attendance Cutover Blocked", "bad"),
...
def _attendance_issue_row(issue) -> dict:
    ...
    label_by_kind = {
        "attendance_cutover_blocked": "Live rollout stayed in shadow",
...
def build_summary() -> dict:
    ...
    summary = {
        ...
        "attendance_location_mode": attendance_snapshot.mode,
