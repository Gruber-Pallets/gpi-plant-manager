...
Full database-backed suite in the isolated checkout: **7,287 passed, 21 skipped, zero failures**. Ruff across src/tests/scripts and whitespace checks passed. The concurrent timeclock-lightbulb commit was incorporated before delivery. Deployment and CI verification follow the implementation push.
